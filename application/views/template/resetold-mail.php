          ...
          <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: center;">  
            <tr>
              <td height="70" style="padding: 0 20px 20px 0; text-align: center;">
               <a href="https://ctinfotech.com/CTCC/goinflu/" style="text-align: center;"><img src="https://ctinfotech.com/CTCC/goinflu/assets/logo.png" alt="" class="w-100" style="width: 30%;"></a>
              </td>
            </tr>
          </table>
